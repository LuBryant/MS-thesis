...
\label{chap:Spin_Nernst_Effect}
    \section{味能斯特系数与温度的变化关系}
        ...
        \begin{equation}
            L(\symup{\tilde{\symbfup{\Omega}}}^s_{xy})=\text{sgn}(\symup{\tilde{\symbfup{\Omega}}}^s_{xy})\ln(1+|\symup{\tilde{\symbfup{\Omega}}}^s_{xy}|)
        \end{equation}
        ...
        \begin{figure}[b]
            ...
            \caption{由对数化的自旋 Berry 曲率 $L(\tilde{\symbfup{\Omega}}^s_n)$ 着色的色散关系，以及 DOS $\mathcal{D}(E)$ 和 DOsB $\mathcal{D}^s_{\alpha \beta}(E)$。(a) 为 $s=y$ 的情况，(b) 为 $s=z$ 的情况。图片来自\cite{lu2024Spin}。}
        ...
        \begin{align}
            ...
            \mathcal{D}^s_{\alpha\beta}(E)&= \int_{BZ} \sum_n \frac{d{\bm{k}}}{(2\pi)^2} \delta(E - E_n({\bm{k}})) \symup{\tilde{\symbfup{\Omega}}}^s_{\alpha\beta,n{\bm{k}}}.
        \end{align}
    ...
    \section{味能斯特系数与各项异性相互作用的变化关系}
        ...
        \begin{equation}
            \tilde{\symup{\Omega}}^z_{xy,n{\bm{k}}} \sim \left( \frac{1}{V} \sum_{\bm{k}} S^z_{n{\bm{k}}} \right) \symup{\Omega}_{xy,n{\bm{k}}},
        \end{equation}
    ...
    综上所述，本章通过数值计算和理论分析，揭示了二维 pyrochlore 薄层中自旋能斯特效应的多场调控机制，阐明了温度、各项异性、DM 相互作用和外磁场对味能斯特系数的综合影响。研究成果不仅加深了我们对自旋能斯特效应物理本质的理解，还为通过外部参数调控热自旋电流提供了理论支持，具有潜在的压电自旋电子学应用价值。